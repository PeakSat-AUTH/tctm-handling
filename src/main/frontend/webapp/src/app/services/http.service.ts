...
export class HttpService {
  ...
  constructor(private http: HttpClient, private instanceHandler: InstanceHandlerService) {
  ...
  getTcResponse(id: string): Observable<CommandHistoryEntry>{
    return this.http.get<CommandHistoryEntry>(`${yamcsBaseUrl}/archive/${this.yamcsInstanceName}/commands/${id}`);
  }
